<template>
  <div class="ww-datagrid" :class="{ editing: isEditing }" :style="cssVars">
    <ag-grid-vue
      ...
      :cellSelection="content.enableCellSelection === true"
      :suppressCellFocus="content.enableCellSelection !== true"
...
export default {
  ...
  computed: {
    ...
    columnDefs() {
      if (!this.content.columns || !Array.isArray(this.content.columns) || this.content.columns.length === 0) {
        return [];
      }
