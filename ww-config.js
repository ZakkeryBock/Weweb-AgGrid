export default {
  ...
  properties: {
    ...
    enableCellSelection: {
      ...
      defaultValue: false,
      propertyHelp: {
        tooltip: "When enabled, clicking on a cell will highlight it with a border. When disabled, cells will not show selection highlighting.",
      },
    },
    cellSelectionBorderColor: {
      type: "Color",
      ...
      hidden: (content) => content.enableCellSelection === false,
    },
